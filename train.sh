...
python tools/test_for_train.py --config-file   logs/resnext101_2_final/config.yaml   --submit-file ./submit3.csv   MODEL.WEIGHTS  ./logs/resnext101_2_final/model_final.pth 
python tools/test_for_train.py --config-file   logs/resnext101_3_final/config.yaml   --submit-file ./submit4.csv   MODEL.WEIGHTS  ./logs/resnext101_3_final/model_final.pth 
python tools/test_for_train.py --config-file   logs/resnext101_2_final/config.yaml   --submit-file ./submit5.csv   MODEL.WEIGHTS  ./logs/resnext101_con_final/model_final.pth 
python tools/test_for_train.py --config-file   logs/resnext101_con_final/config.yaml  --submit-file ./submit6.csv  MODEL.WEIGHTS   ./logs/resnext101_mean_tri_final/model_final.pth 
python tools/test_for_train.py --config-file   logs/resnext101_ms_final/config.yaml    --submit-file ./submit7.csv  MODEL.WEIGHTS ./logs/resnext101_ms_final/model_final.pth 
python tools/test_for_train.py --config-file   logs/resnext101_1_final/config.yaml   --submit-file ./submit8.csv   MODEL.WEIGHTS  ./logs/resnext101_1_final/model_final.pth 
