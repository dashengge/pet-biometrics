...
python tools/average_checkpoints.py --log-dir logs_submit_test/resnext101_con
python tools/average_checkpoints.py --log-dir logs_submit/resnext101_1
python tools/test_for_train.py --config-file   logs_submit_test/resnext101_con/config.yam   --submit-file ./resnext101_con.csv     MODEL.WEIGHTS  ./logs_submit_test/resnext101_con/avg_model.pth
...
# python tools/test_for_train.py --config-file   logs/resnext101_1_final/config.yaml   --submit-file ./submit1.csv   MODEL.WEIGHTS  ./logs/resnext101_1_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnext101_ms_final/config.yaml    --submit-file ./submit2.csv  MODEL.WEIGHTS ./logs/resnext101_ms_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnext101_con_final/config.yaml  --submit-file ./submit3.csv  MODEL.WEIGHTS   ./logs/resnext101_mean_tri_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnext101_2_final/config.yaml   --submit-file ./submit4.csv   MODEL.WEIGHTS  ./logs/resnext101_con_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnext101_2_final/config.yaml   --submit-file ./submit5.csv   MODEL.WEIGHTS  ./logs/resnext101_2_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnext101_3_final/config.yaml   --submit-file ./submit6.csv   MODEL.WEIGHTS  ./logs/resnext101_3_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnet101_2_final/config.yam   --submit-file ./submit7.csv     MODEL.WEIGHTS  ./logs/resnet101_2_final/model_final.pth 
# python tools/test_for_train.py --config-file   logs/resnet101_1_final/config.yam   --submit-file ./submit8.csv     MODEL.WEIGHTS  ./logs/resnet101_1_final/model_final.pth 
