...
def main(args):
    ...
    # print(modelx).shape)
    data_dir = "./datasets/pet_biometric_challenge_2022/validation/images"
    with open("./datasets/pet_biometric_challenge_2022/validation/valid_data.csv", "r") as f:
        data =f.readlines()
        data = data[1:]
    # all_img = []
    ...
    with open("./datasets/pet_biometric_challenge_2022/validation/submit_all_data_2instance.csv", "w") as f1:
