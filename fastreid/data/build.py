...
def _train_loader_from_config(cfg, is_train, *, train_set=None, transforms=None, sampler=None, **kwargs):
...
def build_reid_train_loader(
        train_set, *, is_train, sampler=None, total_batch_size, num_workers=0
):
    """
