...
class BaselineOimSiamese(nn.Module):
    """
            ...
            'loss_kwargs':
                {
                    ...
                    'oim_arc': {
                        'scale': cfg.MODEL.LOSSES.OIMARC.SCALE
                    }
                }
        }
    ...
    def losses(self, outputs, gt_labels=None):
        """
        ...
        if not self.training:
            predicts = self.oim_loss(outputs)
            return predicts
