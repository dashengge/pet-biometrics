...
_C.MODEL.TYPE = "swin_mlp"
_C.MODEL.NAME="swin_mlp_base_patch4_window7_224"
_C.MODEL.DROP_RATE = 0.0

_C.MODEL.DROP_PATH_RATE=0.5
# _C.MODEL.SWIN_MLP = CN()
# _C.MODEL.SWIN_MLP.EMBED_DIM=128
# _C.MODEL.SWIN_MLP.DEPTHS=[ 2, 2, 18, 2 ]
# _C.MODEL.SWIN_MLP.NUM_HEADS=[ 4, 8, 16, 32 ]
...
_C.MODEL.LOSSES.OIM = CN()
_C.MODEL.LOSSES.OIM.SCALE = 1.0
