...
_C.MODEL.LOSSES.OIMARC = CN()
_C.MODEL.LOSSES.OIMARC.SCALE = 1.0
...
_C.INPUT.MOTION = CN({"ENABLED": False})
_C.INPUT.JEPG = CN({"ENABLED": False})
_C.INPUT.GAUSS = CN({"ENABLED": False})
# Random Affine
